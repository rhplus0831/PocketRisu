...
export const languageEnglish = {
    ...
    pluginPermissionEditorHint: "Changes are saved immediately. Revoked permissions stay blocked until you grant them here.",
    ...
    legacyPluginCompatibilityDesc: "Give legacy plugins more time to unload, permit a limited set of cleanup and storage calls during onUnload, and treat teardown-only failures as warnings. Plugin startup and database save failures remain strict.",
