export const languageEnglish = {
    ...
    help: {
        ...
        iconOptimization: "When enabled, icon images (character portraits, persona icons, folder icons) are automatically resized and converted to WebP on the server. Cached in save/cached-icons for fast repeat loading.",
    ...
    selectAndCopy: "Select and Export",
    selectAndCopyDesc: "Select messages to export as rendered HTML",
    selectAndCopySelectRange: "Click a message to set range start/end",
    selectAndCopyConfirm: "Download Selected Range",
    selectAndCopyCancel: "Cancel Selection",
    selectAndCopyDone: "HTML file downloaded",
    selectAndCopyGenerating: "Generating HTML...",
    selectAndCopyArca: "Arca.live",
    ...
    iconOptimization: "Automatic Icon Optimization",
