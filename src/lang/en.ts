...
export const languageEnglish = {
    ...
    pluginStorageRecoveryDesc: "Automatic reconciliation found suspect rows. PocketRisu kept the inline and external copies instead of overwriting or deleting them. Fix transient server access or restore the affected data from a backup, then retry. Diagnostics contain encoded keys only.",
    pluginStorageRecoveryRetry: "Retry reconciliation",
