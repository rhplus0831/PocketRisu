...
export const languageEnglish = {
    ...
    resourceCacheDesc: "Reuse verified database and chat data stored on this device for faster starts and fewer downloads. Disabling this clears all cached data.",
