export const languageKorean = {
    ...
    "help": {
        ...
        "iconOptimization": "활성화되면 아이콘 이미지(캐릭터 초상화, 페르소나 아이콘, 폴더 아이콘)를 서버에서 자동으로 리사이즈하고 WebP로 변환합니다. 데이터 사용량과 메모리 사용량을 줄입니다",
        ...
        "disableServerTokenizer": "토큰 계산을 서버에 위임하지 않고 항상 브라우저에서 처리합니다. 서버 측 토크나이저가 오히려 채팅 준비를 느리게 만든다면 켜 주세요."
    },
    "setup": {
    ...
    "selectAndCopy": "선택하여 내보내기",
    "selectAndCopyDesc": "메시지를 렌더링된 HTML로 내보냅니다",
    "selectAndCopySelectRange": "메시지를 클릭하여 범위의 시작/끝을 설정하세요",
    "selectAndCopyConfirm": "선택 범위 다운로드",
    "selectAndCopyCancel": "선택 취소",
    "selectAndCopyDone": "HTML 파일이 다운로드되었습니다",
    "selectAndCopyGenerating": "HTML 생성 중...",
    "selectAndCopyArca": "아카라이브",
    ...
    disableServerTokenizer: "서버 사이드 토크나이저 비활성화",
