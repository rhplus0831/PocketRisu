...
| [Chat-version cap collapses from 125 to 100](audit/chat-version-cap-collapses-from-125-to-100.md) | Fixed | Medium | The oldest 20% of the advertised recovery depth, dropped at once | Reaching the 125th version; fixed with direct logical-count enforcement and exact 125/126 coverage |
