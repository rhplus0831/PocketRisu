...
`Status` column uses `Open`, `Fixed`, or `Deferred`; 44 findings are currently
`Open`, 15 are `Fixed`, and 1 is `Deferred`. Per-document severities are 15 High, 38 Medium, and 7 Low, but this
