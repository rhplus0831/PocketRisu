...
| v2 whole-codebase audit | data loss | 2026-07-25 @ `bbe0e024` (13 fatal + 23 warning) | consolidated into `docs/findings/audit/` |
| v3 whole-codebase audit | data loss (4 lenses) | 2026-07-26 @ `1a7952f1` (6 fatal + 35 warning) | consolidated into `docs/findings/audit/` |
| Compatibility investigation | main→serve compat | 2026-07-29 @ `f2da33aa` (46 reports, 20 sub-agents) | `docs/findings/compatibility/` |
...
| Performance audit phases 0–4 | perf + concurrency charter | 2026-08-04 @ `7ddb8aca`/`ebc7ec88`, system-wide; scope seed `08ce0647..HEAD` | `docs/findings/perf-audit/` |
